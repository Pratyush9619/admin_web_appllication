...
class StatutoryAprovalA4 extends StatefulWidget {
  ...
  String? depoName;
  String? cityName;
  StatutoryAprovalA4({Key? key, this.depoName, this.cityName})
      : super(key: key);
...
class _StatutoryAprovalA4State extends State<StatutoryAprovalA4> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Key Events / ' + widget.depoName! + ' /A4'),
  ...
  Future<void> getFirestoreData() async {
    ...
    CollectionReference tabledata = instance.collection('${widget.depoName}A4');
