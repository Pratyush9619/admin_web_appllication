...
class StatutoryAprovalA7 extends StatefulWidget {
  ...
  String? depoName;
  String? cityName;
  StatutoryAprovalA7({Key? key, this.depoName, this.cityName})
      : super(key: key);
...
class _StatutoryAprovalA7State extends State<StatutoryAprovalA7> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Key Events / ' + widget.depoName! + ' /A7'),
  ...
  Future<void> getFirestoreData() async {
    ...
    CollectionReference tabledata = instance.collection('${widget.depoName}A7');
